    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Администратор'), ('moderator', 'Модератор'), ('user', 'Пользователь')], default='user', max_length=10, verbose_name='Тип пользователя')),
                ('confirmation_code', models.UUIDField(default=0, editable=False, verbose_name='Код подтверждения')),
